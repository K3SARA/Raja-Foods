import { calculateTotals, DEFAULT_TAX_RATE } from "@raja-food/shared";

export const seedState = {
  settings: {
    businessName: "Raja Food Distributor POS",
    currency: "LKR",
    taxRate: DEFAULT_TAX_RATE
  },
  products: [
    { id: "p-001", name: "Raja Food 500ml", sku: "PEP500", category: "Soft Drinks", price: 1.5, billingPrice: 1.2, mrp: 1.5, stock: 420 },
    { id: "p-002", name: "Raja Food 1.5L", sku: "PEP1500", category: "Soft Drinks", price: 2.9, billingPrice: 2.35, mrp: 2.9, stock: 280 },
